...
/**
 * Třída reprezentující typ portu "Input Chemicals"
 *
 * @author Radek Hůlka
 * @author Pavel Janko
 */
public class InputChemicals extends AbstractType {

    private final static String TYPE_NAME = "Input Chemicals";
    private final static int NUMBER_OF_VALUES = 3;
    public final static String[] VALUES_NAMES = {"Hydrogenium weight", "Oxid weight", "Methan weight"};

    private double[] values;

    public InputChemicals() {
