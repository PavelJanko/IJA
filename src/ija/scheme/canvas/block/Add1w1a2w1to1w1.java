...
/**
 * Třída reprezentující blok sčítačky, která má 2 vstupní a 1 výstupní port s typem "One Decimal Number". Provede sečtení Všech hodnot na vstupních portech a výsledek pošle na výstupní port.
 *
 * @author Radek Hůlka
 * @author Pavel Janko
 */
public class Add1w1a2w1to1w1 extends AbstractBlock
{
    ...
    public Add1w1a2w1to1w1(double x, double y, double canvasWidth, double canvasHeight) {
        super.loadFXML(this, "add1w1a2w1to1w1.fxml");
