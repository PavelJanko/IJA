...
/**
 * Třída reprezentující blok odčítačky, která má 2 vstupní a 1 výstupní port s typem "One Decimal Number". Provede odečtení hodnoty na druhém vstupním portu od hodnoty na druhém vstupním portu a výsledek pošle na výstupní port.
 *
 * @author Radek Hůlka
 * @author Pavel Janko
 */
public class Sub1w1a2w1to1w1 extends AbstractBlock
{
    ...
    private final static String BLOCK_NAME = "SUB";

    public Sub1w1a2w1to1w1(double x, double y, double canvasWidth, double canvasHeight) {
        super.loadFXML(this, "sub1w1a2w1to1w1.fxml");
