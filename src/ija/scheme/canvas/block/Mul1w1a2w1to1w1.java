...
/**
 * Třída reprezentující blok násobičky, která má 2 vstupní a 1 výstupní port s typem "One Decimal Number". Provede vynásobění hodnoty na prvním vstupním portu hodnotou na druhém vstupním portu a výsledek pošle na výstupní port.
 *
 * @author Radek Hůlka
 * @author Pavel Janko
 */
public class Mul1w1a2w1to1w1 extends AbstractBlock
{
    ...
    private final static String BLOCK_NAME = "MUL";

    public Mul1w1a2w1to1w1(double x, double y, double canvasWidth, double canvasHeight) {
        super.loadFXML(this, "mul1w1a2w1to1w1.fxml");
